...
export const jobSchemaZod = z.object({
  ...
  followUpDate: z.string().or(z.date()).optional().nullable().or(z.literal("")),
  interviewDate: z.string().or(z.date()).optional().nullable().or(z.literal("")),
  assessmentDeadline: z.string().or(z.date()).optional().nullable().or(z.literal("")),
  offerDeadline: z.string().or(z.date()).optional().nullable().or(z.literal("")),
