...
import { 
  ...
  LineChart, Calendar, FileText, Globe, Check, Star 
} from 'lucide-react';
        ...
        <div className="w-full max-w-[460px] space-y-7 relative z-10">
          ...
          <div className="bg-[#121214]/65 border border-white/10 backdrop-blur-2xl p-9 sm:p-10 rounded-[2rem] shadow-2xl space-y-7 relative overflow-hidden">
            ...
            <div className="text-center space-y-1.5 relative z-10">
              <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-white">Create Account</h2>
              <p className="text-sm text-zinc-300 font-semibold">Sign up today and replace spreadsheets forever</p>
            </div>
          ...
          <p className="text-center text-sm text-zinc-300 font-medium">
            ...
            <Link to="/login" className="font-extrabold text-indigo-400 hover:text-indigo-300 hover:underline transition">
              Sign in here
            </Link>
          </p>
        </div>
